...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/PhotoEditorSDK/PhotoEditorSDK/ImglyKit.framework"
  install_dsym "${PODS_ROOT}/PhotoEditorSDK/PhotoEditorSDK/ImglyKit.framework.dSYM"
